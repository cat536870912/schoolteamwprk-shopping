...
<table>
<?php
for($i=0;$i<=mysql_num_rows($data)-1;$i++)
{
?>
	<tr> 
        <td >
         名稱：<?php echo mysql_result($name,$i);?><br>
         價格：$ <?php echo mysql_result($price,$i);?><br>
         剩餘數量：<?php echo mysql_result($count,$i);?>個<br>
         介紹：<?php echo mysql_result($intro,$i);?>
         &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onClick="disp_alert('parent','login.php')" value="加入購物車"> 
        </td>
        
		<td align="center"><img src="images/<?php echo mysql_result($picture,$i);?>.gif" height="150" width="150" ></td>
  	</tr>
    <tr></tr>
