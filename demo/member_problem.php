...
<div class="site-body" style="background-color: #ffffff">
  <article>
    ...
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新客戶請點選 [癡餅--吃吃牛舌餅] 首頁右上方「註冊」，</li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;填寫「您的基本資料」→ 再輸入「帳號」→ 請自訂「密碼」→再輸入一次「密碼」，即註冊完成；</li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提醒您請務必填入有效信箱設置帳號，否則訂單相關訊息將無法順利通知。</li>
    </ul>
    <ul style="padding:10px 0; font-size: 20px;text-align: left;font-weight: bold;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 帳號密碼是否有限制?</li>
    </ul>
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;訂購帳號需不與他人重複，並設定您慣用的密碼即可；密碼請輸入6碼~16碼，限用英文、數字、底線。</li>
    </ul>
    <ul style="padding:10px 0; font-size: 20px;text-align: left;font-weight: bold;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. 忘記密碼怎麼辦?</li>
    </ul>
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;請於登入頁面，直接點選 忘記密碼 ，並輸入驗證碼，將透過E-mail發送密碼提醒至您的信箱。</li>
    </ul>
    <ul style="padding:10px 0; font-size: 20px;text-align: left;font-weight: bold;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4. 如何修改密碼?</li>
    </ul>
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;請至 我的帳戶 > 修改密碼 ，輸入帳號、密碼登入後，輸入新密碼，即可變更。</li>
    </ul>
  </article>
</div>
    <!-- CONTENT END -->
