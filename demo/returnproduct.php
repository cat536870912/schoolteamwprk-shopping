     ...
     <div class="container">
         <div class="inner">
             <nav class="nav-menu">
                 <div class="container">
                     <ul class="menu-one">
                       <li id="A18311"><a href="index.php">首頁</a></li>
                       <li id="A19639"><a href="story.php">品牌故事</a></li>
                       <li id="A18312"><a href="product.php">商品瀏覽</a></li>
                       <li id="A23356"><a href="login.php">客戶服務</a></li>
                     </ul>
                 </div>
             </nav>
          </div>
...
<!-- CONTENT START -->
<div class="site-body" style="background-color: #ffffff">
  <article>
    <ul style="padding:10px 0; font-size: 28px;text-align: left;font-weight: bold;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;退貨說明</li>
    </ul>
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 全站購物皆可享有商品到貨 七天猶豫期 之權益，若收到的商品有任何問題，可於七天內直接退貨。</li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• 如果需要換貨，請先至網站退貨，再重新下單。</li>
      <li></li>
      <li></li>
    </ul>
    <ul style="padding:10px 0; font-size: 24px;text-align: left;font-weight: bold;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;退貨說明</li>
      <li></li>
    </ul>
    <ul style="padding:10px 0; font-size: 16px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 如需退貨請至 我的帳戶 > 查訂單 進行退訂。</li>
      <li></li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 完成退訂申請後，我們將於2-3個工作天內派快遞前往取件，取件費用由我們支付。 </li>
      <li>    </li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    ※ 取貨前宅配公司可能與您聯繫，請保持電話暢通，不要拒接不明來電顯示。</li>
      <li></li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. 待商品收回並驗收無誤後，將進行退款，並於退款日當天發送E-mail通知您。</li>
    </ul>
    <ul style="padding:10px 0; font-size: 14px;text-align: left;">
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;《請注意》</li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品退貨必須是全新且完整包裝(包括且不限於產品、附件、贈品、包裝、原廠紙箱及所有附隨文件或資料之完整性)，</li>
      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;否則將影響您退貨權益的行使或需負擔毀壞之費用。</li>
    </ul>
  </article>
</div>
    <!-- CONTENT END -->
...
<footer class="rwd_footer_001" >
  <div class="container">
    <div class="links">
	  ...
	  <dl>
		<dt>配送須知</dt>
		  <dd><a href="arrivaltime.php">到貨時間說明</a></dd>
	   	  <dd><a href="fee.php">運費及免運門檻</a></dd>
	  </dl>
	  <dl>
		<dt>售後服務說明</dt>
		  <dd><a href="returnproduct.php">退貨說明</a></dd>
		  <dd><a href="returnmoney.php">退款說明</a></dd>
	  </dl>
	  <dl>
		<dt>付款方式</dt>
		  <dd><a href="custom.php">ATM</a></dd>
		  <dd><a href="custom.php">貨到付款	</a></dd>
	  </dl>
	  <dl>
		<dt>常見問題</dt>
		  <dd><a href="member_problem.php">帳戶問題	</a></dd>
		  <dd><a href="orderform_problem.php">訂單問題	</a></dd>
	  </dl>
    </div>		
  </div>
</footer>
