...
<div id="main">
    ...
    <div id="ma_right" align="center">
        <form action="p_salary_sql.php" method="post">
            <fieldset>
                <legend><b>發放薪資</b></legend>
                <table>
                    <tr>
                        <td>員工姓名：</td>
                        <td>
                            <select id="shopList" name="name">
                                <option></option>
                            </select> 
                        </td>
                    </tr>
                    ...
                    <tr align="center">
                        <td colspan="2">
                            ...
                            <a href="http://140.135.113.41/back/changken_center/salary.php"><input type="button" name="button" value="回前頁" /><br>
                        </td>
                    </tr>
                </table>
            </fieldset>	
...
$shops = mysql_query("select * from employee");
if(!$shops)
{
