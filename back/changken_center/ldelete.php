...
<body>
<h1 style="text-align: center;">刪除訂單</h1>
...
if($_SESSION['level']=="user")
{
	...
	echo '<meta http-equiv=REFRESH CONTENT=1;url=http://140.135.113.41/back/changken_center/list.php>';
...
{
?>	
	<form method="post" action="ldeletec.php" name="ldelete">
		<table style="text-align: center; width: 100px; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
			<tbody>
				<tr>

					<td style="vertical-align: top;">
						訂單編號:<input name="no" type="text"><br>
						<input name="edelete" value="刪除" type="submit">
						<a href="http://140.135.113.41/back/changken_center/list.php"><input type="button" name="button" value="回前頁" /><br>
					</td>
				</tr>
			</tbody>
		</table>
