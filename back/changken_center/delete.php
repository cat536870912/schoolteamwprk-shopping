...
if($_SESSION['level']=="user")
{
	...
	echo '<meta http-equiv=REFRESH CONTENT=1;url=http://140.135.113.41/back/changken_center/mstock.php>';
			...
			<tbody>
				<tr>
					...
					<td style="vertical-align: top;">
						會員帳號:<input name="id" type="text"><br>
						<input name="delete" value="刪除" type="submit">
						<a href="http://140.135.113.41/back/changken_center/mstock.php"><input type="button" name="button" value="回前頁" /><br>
					</td>
				</tr>
			</tbody>
		</table>
